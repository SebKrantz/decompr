...
The result is a long-format data frame with one row per (exporting country-industry,
...
wz[wz$Importing_Country == "Germany",
   c("Exporting_Country", "Exporting_Industry", "DVA_FIN")]
```
